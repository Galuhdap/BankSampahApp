...
class ListPenjualanSuperAdminScreen extends StatefulWidget {
  const ListPenjualanSuperAdminScreen({super.key});

  @override
  State<ListPenjualanSuperAdminScreen> createState() =>
      _ListPenjualanSuperAdminScreenState();
}

class _ListPenjualanSuperAdminScreenState
  ...
  void initState() {
    ...
    _futureData = SampahSuperAdminController().getPenjalanAdmin();
    super.initState();
  }
