...
class EditPenimbangScreen extends StatefulWidget {
  ...
  final String nama_penimbang;
  final String no_telp;
  final String alamat;
  final String rt;
  final String rw;

  const EditPenimbangScreen({
    Key? key,
    required this.kode_penimbang,
    required this.nama_penimbang,
  ...
  @override
  State<EditPenimbangScreen> createState() => _EditPenimbangScreenState();
}

class _EditPenimbangScreenState extends State<EditPenimbangScreen> {
  TextEditingController namaPenimbangController = TextEditingController();
  ...
  void initState() {
    ...
    namaPenimbangController.text = widget.nama_penimbang;
