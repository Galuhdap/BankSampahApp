...
class SuccesKeuntunganScreen extends StatefulWidget {
  final String kode_invoice;
  final int jumlah_penarikan;

  const SuccesKeuntunganScreen(
      {super.key,
      required this.kode_invoice,
      required this.jumlah_penarikan,});

  @override
  State<SuccesKeuntunganScreen> createState() => _SuccesKeuntunganScreenState();
}

class _SuccesKeuntunganScreenState extends State<SuccesKeuntunganScreen> {
  @override
