...
class SuccesDanaScreen extends StatefulWidget {
  ...
  @override
  State<SuccesDanaScreen> createState() => _SuccesDanaScreenState();
}

class _SuccesDanaScreenState extends State<SuccesDanaScreen> {
  @override
